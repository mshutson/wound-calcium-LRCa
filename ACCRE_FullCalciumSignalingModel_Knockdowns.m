...
knockoutSpec={"GJ","PLC"}[[ToExpression[Environment["SLURM_ARRAY_TASK_ID"]]]]

knockoutVal=If[knockoutSpec=="GJ",0.,.3](*percentage to keep for knockout (so 1 - this for percent knockdown)*);
