...
Export["FullModel_param9_GJFlux.tif",frames2D,"FrameRate"->10];

Export["GJFlux_allCalcium.m",test];

Export["randGJmults.m",randGJmults];

Export["gcampRandVals.m",gcampRandVals];
